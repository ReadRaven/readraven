...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'raven_feed', 'site',
                      self.gf('django.db.models.fields.URLField')(max_length=500, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.site'
        db.delete_column(u'raven_feed', 'site')
    ...
    models = {
        ...
        u'raven.feed': {
            ...
            'site': ('django.db.models.fields.URLField', [], {'max_length': '500', 'unique': 'True', 'null': 'True'}),
