...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.subscription'
        db.add_column(u'raven_feed', 'subscription',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='feed', null=True, to=orm['subscriber.Subscription']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.subscription'
        db.delete_column(u'raven_feed', 'subscription_id')
