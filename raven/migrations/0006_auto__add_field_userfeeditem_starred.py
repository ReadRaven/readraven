...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserFeedItem.starred'
        db.add_column(u'raven_userfeeditem', 'starred',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserFeedItem.starred'
        db.delete_column(u'raven_userfeeditem', 'starred')
