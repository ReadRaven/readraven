...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UserFeedItem', fields ['feed', 'item', 'user']
        db.create_unique(u'raven_userfeeditem', ['feed_id', 'item_id', 'user_id'])

        # Adding unique constraint on 'FeedItem', fields ['feed', 'guid']
        db.create_unique(u'raven_feeditem', ['feed_id', 'guid'])


    def backwards(self, orm):
        # Removing unique constraint on 'FeedItem', fields ['feed', 'guid']
        db.delete_unique(u'raven_feeditem', ['feed_id', 'guid'])

        # Removing unique constraint on 'UserFeedItem', fields ['feed', 'item', 'user']
        db.delete_unique(u'raven_userfeeditem', ['feed_id', 'item_id', 'user_id'])
    ...
    models = {
        ...
        u'raven.feeditem': {
            'Meta': {'unique_together': "(('feed', 'guid'),)", 'object_name': 'FeedItem'},
        ...
        u'raven.userfeeditem': {
            'Meta': {'unique_together': "(('user', 'feed', 'item'),)", 'object_name': 'UserFeedItem'},
