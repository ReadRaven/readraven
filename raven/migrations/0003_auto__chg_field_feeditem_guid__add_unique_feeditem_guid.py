...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedItem.atom_id'
        db.add_column(u'raven_feeditem', 'atom_id',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True),
                      keep_default=False)


        # Changing field 'FeedItem.guid'
        db.alter_column(u'raven_feeditem', 'guid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128))
        # Adding unique constraint on 'FeedItem', fields ['guid']
        db.create_unique(u'raven_feeditem', ['guid'])


    def backwards(self, orm):
        # Removing unique constraint on 'FeedItem', fields ['guid']
        db.delete_unique(u'raven_feeditem', ['guid'])

        # Deleting field 'FeedItem.atom_id'
        db.delete_column(u'raven_feeditem', 'atom_id')


        # Changing field 'FeedItem.guid'
        db.alter_column(u'raven_feeditem', 'guid', self.gf('django.db.models.fields.CharField')(max_length=500))
