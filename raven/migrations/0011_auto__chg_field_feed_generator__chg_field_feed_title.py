...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Feed.generator'
        db.alter_column(u'raven_feed', 'generator', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Feed.title'
        db.alter_column(u'raven_feed', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))
