...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'raven_feeditem', 'title', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'FeedItem.title'
        db.alter_column(u'raven_feeditem', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))
