...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.fetch_frequency'
        db.add_column(u'raven_feed', 'fetch_frequency',
                      self.gf('django.db.models.fields.IntegerField')(default=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.fetch_frequency'
        db.delete_column(u'raven_feed', 'fetch_frequency')
    ...
    models = {
        ...
        u'raven.feed': {
            ...
            'fetch_frequency': ('django.db.models.fields.IntegerField', [], {'default': '60'}),
