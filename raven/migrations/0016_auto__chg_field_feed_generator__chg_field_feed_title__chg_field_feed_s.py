...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feed.generator'
        db.alter_column(u'raven_feed', 'generator', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Feed.title'
        db.alter_column(u'raven_feed', 'title', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Feed.site'
        db.alter_column(u'raven_feed', 'site', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Feed.link'
        db.alter_column(u'raven_feed', 'link', self.gf('django.db.models.fields.TextField')(unique=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Feed.generator'
        db.alter_column(u'raven_feed', 'generator', self.gf('django.db.models.fields.CharField')(max_length=1023))

        # Changing field 'Feed.title'
        db.alter_column(u'raven_feed', 'title', self.gf('django.db.models.fields.CharField')(max_length=1023))

        # Changing field 'Feed.site'
        db.alter_column(u'raven_feed', 'site', self.gf('django.db.models.fields.URLField')(max_length=1023, null=True))

        # Changing field 'Feed.link'
        db.alter_column(u'raven_feed', 'link', self.gf('django.db.models.fields.URLField')(max_length=1023, unique=True))

        # Changing field 'FeedItem.atom_id'
        db.alter_column(u'raven_feeditem', 'atom_id', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
    ...
    models = {
        ...
        u'raven.feeditem': {
            ...
            'atom_id': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
