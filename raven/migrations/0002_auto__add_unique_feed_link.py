...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Feed', fields ['link']
        db.create_unique(u'raven_feed', ['link'])


    def backwards(self, orm):
        # Removing unique constraint on 'Feed', fields ['link']
        db.delete_unique(u'raven_feed', ['link'])
