...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'raven_feed', 'link', self.gf('django.db.models.fields.URLField')(unique=True, max_length=1023))

        # Changing field 'FeedItem.link'
        db.alter_column(u'raven_feeditem', 'link', self.gf('django.db.models.fields.URLField')(max_length=1023))

    def backwards(self, orm):

        # Changing field 'Feed.site'
        db.alter_column(u'raven_feed', 'site', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))

        # Changing field 'Feed.link'
        db.alter_column(u'raven_feed', 'link', self.gf('django.db.models.fields.URLField')(max_length=500, unique=True))

        # Changing field 'FeedItem.link'
        db.alter_column(u'raven_feeditem', 'link', self.gf('django.db.models.fields.URLField')(max_length=500))
