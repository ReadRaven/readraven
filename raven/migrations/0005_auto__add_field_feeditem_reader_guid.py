...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedItem.reader_guid'
        db.add_column(u'raven_feeditem', 'reader_guid',
                      self.gf('django.db.models.fields.CharField')(max_length=48, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedItem.reader_guid'
        db.delete_column(u'raven_feeditem', 'reader_guid')
